...
export class Quadratic extends Shape {
  ...
  constructor(xBound: number, yBound: number) {
    ...
    this.x2 = this.x1 + randomIntInclusive(-Quadratic.MAX_SIZE, Quadratic.MAX_SIZE);
    this.y2 = this.y1 + randomIntInclusive(-Quadratic.MAX_SIZE, Quadratic.MAX_SIZE);
    this.x3 = this.x1 + randomIntInclusive(-Quadratic.MAX_SIZE, Quadratic.MAX_SIZE);
    this.y3 = this.y1 + randomIntInclusive(-Quadratic.MAX_SIZE, Quadratic.MAX_SIZE);
  }
