...
| [options.shapeTypes]       | <code>Array.&lt;string&gt;</code> | <code>'Circle','Cubic','Ellipse','Line','Quadratic','Rect','Square','Triangle'</code> | The types of shapes to use when generating the image, available are: `Circle`, `Cubic`, `RotatedEllipse`, `Ellipse`, `Line`, `Quadratic`, `Rect`, `RotatedRect`, `Square` and `Triangle` |
